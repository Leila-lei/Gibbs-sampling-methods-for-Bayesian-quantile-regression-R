...
for (p in quantiles){
    for (dist_eps in dist_eps_list){
        load(paste0("C:\\Users\\juyil\\Documents\\la\\R\\Gibbs with Scale\\","GWS_",p,"_",dist_eps,"_betap.RData"))
        beta_p = list()
        for (i in 1:3){
...
################################################################   
        load(paste0("C:\\Users\\juyil\\Documents\\la\\R\\Gibbs without Scale\\","GWOS_",p,"_",dist_eps,"_betap.RData"))
        beta_p = list()
        for (i in 1:3){
          beta_p[[i]]=unlist(lapply(beta_p_record, function(x){return(x[i,])}))[2001:itr_total]
          # plot(beta_p[[i]], type="l", main=paste("GWS_",p,"_",dist_eps,"_beta_",i), xlab="itr", ylab=paste("beta",i))
...
################################################################
        load(paste0("C:\\Users\\juyil\\Documents\\la\\R\\Double Exponential Prior\\","DEP_",p,"_",dist_eps,"_betap.RData"))
        beta_p = list()
        for (i in 1:3){
          beta_p[[i]]=unlist(lapply(beta_p_record, function(x){return(x[i,])}))[2001:itr_total]
          # plot(beta_p[[i]], type="l", main=paste("GWS_",p,"_",dist_eps,"_beta_",i), xlab="itr", ylab=paste("beta",i))
...
################################################################
        load(paste0("C:\\Users\\juyil\\Documents\\la\\R\\Tobit with Scale\\","TWS_",p,"_",dist_eps,"_betap.RData"))
        beta_p = list()
        for (i in 1:3){
          beta_p[[i]]=unlist(lapply(beta_p_record, function(x){return(x[i,])}))[2001:itr_total]
          # plot(beta_p[[i]], type="l", main=paste("GWS_",p,"_",dist_eps,"_beta_",i), xlab="itr", ylab=paste("beta",i))
...
################################################################
        load(paste0("C:\\Users\\juyil\\Documents\\la\\R\\Tobit without Scale\\","TWOS_",p,"_",dist_eps,"_betap.RData"))
        beta_p = list()
        for (i in 1:3){
          beta_p[[i]]=unlist(lapply(beta_p_record, function(x){return(x[i,])}))[2001:itr_total]
          # plot(beta_p[[i]], type="l", main=paste("GWS_",p,"_",dist_eps,"_beta_",i), xlab="itr", ylab=paste("beta",i))
