...
################################################################
        ...
        for (i in 1:d){
          beta_p[[i]]=unlist(lapply(beta_p_record, function(x){return(x[i,])}))[(burn_in+1):itr_total]
          hist(beta_p[[i]], main=paste("DEP_",p,"_",dist_eps,"_beta_",i), xlab=paste("beta",i))
          abline(v=summary(rqfit)$coefficients[i],col="red",lwd=3)
        }
...
################################################################
        ...
        for (i in 1:d){
          beta_p[[i]]=unlist(lapply(beta_p_record, function(x){return(x[i,])}))[(burn_in+1):itr_total]
          hist(beta_p[[i]], main=paste("TWS_",p,"_",dist_eps,"_beta_",i), xlab=paste("beta",i))
          abline(v=summary(rqfit)$coefficients[i],col="red",lwd=3)
        }
...
################################################################
        ...
        for (i in 1:d){
          beta_p[[i]]=unlist(lapply(beta_p_record, function(x){return(x[i,])}))[(burn_in+1):itr_total]
          hist(beta_p[[i]],  main=paste("TWOS_",p,"_",dist_eps,"_beta_",i), xlab=paste("beta",i))
          abline(v=summary(rqfit)$coefficients[i],col="red",lwd=3)
        }
