...
for (dist_eps in dist_eps_list){
  ...
  for (p in quantiles){
    ...
    save(beta_p_record, file=paste0("C:\\Users\\juyil\\Documents\\la\\R\\mtcars\\Tobit without Scale\\","TWOS_",p,"_",dist_eps,"_betap.RData"))
    save(z_record, file=paste0("C:\\Users\\juyil\\Documents\\la\\R\\mtcars\\Tobit without Scale\\","TWOS_",p,"_",dist_eps,"_z.RData"))
    save(t, file=paste0("C:\\Users\\juyil\\Documents\\la\\R\\mtcars\\Tobit without Scale\\","TWOS_",p,"_",dist_eps,"_t.RData"))
  }
}
