...
for (dist_eps in dist_eps_list){
  for (p in quantiles){
    ...
    save(beta_p_record, file=paste0("cholesky\\Tobit with Scale\\","TWS_",p,"_",dist_eps,"_betap.RData"))
    save(v_record, file=paste0("cholesky\\Tobit with Scale\\","TWS_",p,"_",dist_eps,"_v.RData"))
    save(t, file=paste0("cholesky\\Tobit with Scale\\","TWS_",p,"_",dist_eps,"_t.RData"))
  }
}
